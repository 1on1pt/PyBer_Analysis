...
5. One final recommendation would be to consider "floating" drivers between the city types during off-peak periods.  For instance, in March, urban drivers could possibly have been "floated" to the suburban city type to help pick up any missed rides due to a lack of drivers.  In the same sense, Total Fares were declining at the end of January for the suburban city type as rural Total Fares were increasing.  Suburban drivers could have been "floated" to the rural city type to assist with any potentially missed rides.
